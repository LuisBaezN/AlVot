...
data <- read.csv("~/Maestria/Patrones/Proyecto/Datasets/heart.csv")

set.seed(31) #73

clase <- data[,14]
data <- data[,-14]
data <- data[,c(2,3,6,7,9,11,12,13)] #categ = 2,3,6,7,9,11,12,13
...
columnas_categ <- c(2,3,4,6,7,8) # Para zoo: 13, para heart: 2, 3, 6, 7, 9, 11, 12, 13
